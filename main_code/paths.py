...
# Study Online 抓包数据目录
STUDY_ONLINE_CAPTURE_DIR = STUDY_ONLINE_DIR / "抓包数据"
STUDY_ONLINE_2025_SECOND_HALF_DIR = STUDY_ONLINE_CAPTURE_DIR / "2025下半年"

# Study Online 考试本地数据文件（2025下半年）
EXAM_2025_24_QUESTIONS_FILE = STUDY_ONLINE_2025_SECOND_HALF_DIR / "24级上册题目返回数据.txt"
EXAM_2025_24_ANSWERS_FILE = STUDY_ONLINE_2025_SECOND_HALF_DIR / "24级上册答案提交数据.txt"
EXAM_2025_25_QUESTIONS_FILE = STUDY_ONLINE_2025_SECOND_HALF_DIR / "25级上册题目返回数据.txt"
EXAM_2025_25_ANSWERS_FILE = STUDY_ONLINE_2025_SECOND_HALF_DIR / "25级上册答案提交数据.txt"
